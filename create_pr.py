...
payload = {"title": "Fix for issue #21434", "body": "Closes #21434\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-21434", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/lingdojo/kana-dojo/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
